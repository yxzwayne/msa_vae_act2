...
save_name = sys.argv[2] # MSATr_entropy_10k
n_generate = int(sys.argv[3]) # 10000
n_stack = int(sys.argv[4]) # 4
n_batch = int(sys.argv[5]) # 256
n_mask = int(sys.argv[6]) # 32 # this is 2/3 of sequence length
