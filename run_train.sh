...
echo -e "\n\nTrain"
python vae_keras.py deepsequence_latent8 train DeepSequence $seq_file 8 --epoch 6
echo -e "\n\nPlot latent"
...
echo -e "\n\nTrain"
python vae_keras.py deepsequence_latent30 train DeepSequence $seq_file 30 --epoch 8
echo -e "\n\nPlot latent"
...
echo -e "\n\nTrain"
python vae_keras.py deepVAE_Haldane_latent8 train Deep_VAE $seq_file 8 5 --epoch 6
echo -e "\n\nPlot latent"
