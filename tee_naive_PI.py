...
modelseq_fn = "".join(sys.argv[4].split(".")[:-1])
...
# Replace "potts" with the sequence file name designated in sys.argv 4.
# this could have been better but i just don't bother.
